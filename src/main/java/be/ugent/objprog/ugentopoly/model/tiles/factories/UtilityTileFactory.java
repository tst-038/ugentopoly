...
public class UtilityTileFactory implements TileFactory {
    ...
    public Tile createTile(Element element) {
        return new UtilityTile(element.getAttributeValue("id"), Integer.parseInt(element.getAttributeValue("position")), Integer.parseInt(element.getAttributeValue("cost")));
    }
}